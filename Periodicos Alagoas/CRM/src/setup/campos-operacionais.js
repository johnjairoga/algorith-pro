...
async function setupCamposOperacionais() {
  try {
    console.log('\n');
    console.log('█████████████████████████████████████████████████████');
    console.log('█                                                   █');
    console.log('█  ⚙️  FASE 2: Campos Operacionais em GHL ⚙️       █');
    console.log('█                                                   █');
    console.log('█████████████████████████████████████████████████████\n');

    const ghl = new GHLClient();

    const camposOperacionais = fieldsConfig.fields.operacional || [];
    ...
    console.log(`📝 Criando ${camposOperacionais.length} campos operacionais...\n`);

    for (const field of camposOperacionais) {
      console.log(`⚙️  ${field.displayName}`);
